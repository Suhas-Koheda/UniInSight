...
// Explicitly type dynamic imports
const DynamicPieChart = dynamic(() => import('recharts').then((mod) => mod.PieChart as any), { ssr: false });
const DynamicPie = dynamic(() => import('recharts').then((mod) => mod.Pie as any), { ssr: false });
const DynamicBarChart = dynamic(() => import('recharts').then((mod) => mod.BarChart as any), { ssr: false });
const DynamicBar = dynamic(() => import('recharts').then((mod) => mod.Bar as any), { ssr: false });
const DynamicXAxis = dynamic(() => import('recharts').then((mod) => mod.XAxis as any), { ssr: false });
const DynamicYAxis = dynamic(() => import('recharts').then((mod) => mod.YAxis as any), { ssr: false });
const DynamicTooltip = dynamic(() => import('recharts').then((mod) => mod.Tooltip as any), { ssr: false });
const DynamicLegend = dynamic(() => import('recharts').then((mod) => mod.Legend as any), { ssr: false });
const DynamicCell = dynamic(() => import('recharts').then((mod) => mod.Cell as any), { ssr: false });
...
const MainPage = () => {
  ...
  return (
      <div className="p-4 min-h-screen bg-white text-black">
        ...
        {/* Chart Buttons */}
        <div className="bg-gray-100 p-4 mb-4 rounded-lg shadow-md max-w-xl mx-auto text-center">
          <button
